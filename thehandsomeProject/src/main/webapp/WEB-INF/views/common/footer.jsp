<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div id="footerWrap">
        <div id="topBtn" style="display: block;">
            <a href="javascript:void(0);" class="viewTopArea"><img src="http://cdn.thehandsome.com/_ui/desktop/common/images/common/top_btn.png" alt="맨 위로" ></a>
        </div>
        <div class="footer">
            <!--footer_cnts1 -->
            <div class="footer_cnts1 clearfix">
                ...
                <div class="footer_menu cnts1_left">
                    <div class="footer_logo"><a href="/" ><img src="http://cdn.thehandsome.com/_ui/desktop/common/images/common/footer_logo_renew.png" alt="HANDSOME"></a></div>
        ...
        <div class="footer_cnts2 clearfix">
            <div class="footer">
                <div class="cnts2_left">
                    <a href="#" >서비스이용약관</a>
                    <a href="#" onclick="GA_Event('공통','푸터_CNT','개인정보처리방침');"><strong>개인정보처리방침<!-- 개인정보처리방침 --></strong></a>
                    <a href="javascript:void(0);" class="box" >통신판매사업자정보확인</a>
                    <a href="https://mark.inicis.com/mark/escrow_popup.php?mid=handsomep1" class="box" >에스크로서비스 가입 확인</a>
                ...
                <div class="cnts2_right">
                    ...
                    <dl class="family">
						<dt><a href="javascript:familyToggle()">FAMILY SITE<!-- FAMILY SITE --></a></dt>
						<dd id="familysite_li" style="">
							<ul>
