...
<head>
    ...
    <link rel="stylesheet" href="/resourcescss/common.css">
    <link rel="stylesheet" href="/resourcescss/layout.css">
    <link rel="stylesheet" href="/resourcescss/content.css">
            ...
            <div class="sub_container">
                 <div id="handsomeCust" class="login_wrap box_type_1 renewal1904">
                    <div class="border_box1"><!-- 추가 190417 -->
                        <div class="inner_box">
                            ...
                            <form id="loginForm" name="loginForm" action="/ko/j_spring_security_check" method="post">
                                ...
                                <div class="login1905">
                                    <div><a href="#;" id="otpShow" class="otp">아이디 찾기</a></div>
                    ...
                    <div class="border_box2"><!-- 추가 190417 -->
                        <div class="inner_box step2" style="
                        margin-top: 39px;
                    ">
                            <div class="title_wrap">
