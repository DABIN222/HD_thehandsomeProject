...
<body>
    ...
    <div class="input_infomation" style="
    margin-left: 80px;
    margin-right: 80px;
    margin-bottom: 80px;">
        ...
        <fieldset class="divider">
            ...
            <div class="wrap_inp">
                ...
                <div class="inp_bundle registerCustId">
                    ...
                    <button type="button" class="btn_right btn_typeC2" id="id_check_btn"><span>중복확인</span></button>
            ...
            <div class="wrap_inp">
                ...
                <div class="inp_bundle registerPwd1">
                    <input type="password" title="비밀번호 입력" id="registerPwd1" name="custPwd" maxlength="30" class="inp flex" placeholder="비밀번호">
                </div>
            ...
            <!-- 비밀번호 확인 -->
            <div class="wrap_inp">
                <label for="passwordCheck" class="inp_tit">비밀번호 확인<span class="nec">*</span></label>
                <div class="inp_bundle pwdCheckMsg2">
                    <input type="password" title="비밀번호 확인 입력" id="registerPwd2" name="custPwdConfirm" maxlength="30" class="inp flex" placeholder="비밀번호 확인">
            ...
            <div class="wrap_inp">
                ...
                <div class="inp_bundle email_bundle emailCheckMsg">
                    <input type="email" title="이메일 아이디 입력" id="registerEmail" name="registerEmail" value="" maxlength="80" class="inp flex" placeholder="이메일">
                    ...
                    <div class="wrap_inp">
                        ...
                        <div class="addr_bundle">
                            <div class="inp_bundle">
                                ...
                                <button type="button" class="btn_typeC2 numSrchBt" id="adress_btn"><span>주소검색</span></button>
                            </div>													
                            <div class="inp_bundle">
                                <input type="text" title="주소 입력" name="partner.addr1" id="regAddr1" class="inp flex" placeholder="상세주소" >
                            </div>
