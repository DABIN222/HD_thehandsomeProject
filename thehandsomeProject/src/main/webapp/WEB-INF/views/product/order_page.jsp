                                ...
                                <tbody>
                                    <tr class="al_middle">
                                            <td class="frt">
                                                ...
                                                <a href="/ko/HANDSOME/MEN/TOP/SHIRTS/%ED%94%8C%EB%9E%A9-%ED%8F%AC%EC%BC%93-%EC%85%94%EC%B8%A0/p/SH2CAWSH714M_NY_100"> 
	                                                     <img src="http://newmedia.thehandsome.com/SH/2C/FW/SH2CAWSH714M_NY_S01.jpg" alt="">
	                                                         </a>
                                                     <div class="tlt_wrap">
                                                        <a href="/ko/HANDSOME/MEN/TOP/SHIRTS/%ED%94%8C%EB%9E%A9-%ED%8F%AC%EC%BC%93-%EC%85%94%EC%B8%A0/p/SH2CAWSH714M_NY_100" class="basket_tlt"> 
			                                                        <span class="tlt">${productVO.bname}</span>
			                                                        <span class="sb_tlt">${productVO.pname }</span>                                                            
																	</a>
			                                                        <p class="color_op">
			                                                                    
			                                                                        color : ${colorVO.cname }<span class="and_line">/</span>
...
<td>1</td>
                                            <td>
                                                ...
                                                <div class="price_wrap ">
                                                	<span id="sum_price">
		                                                                ₩ ${order_sumprice}</span><input
								type="hidden" id="sumprice" value="${order_sumprice}">
		                                                        </div> <!-- //price_wrap -->
                                            </td>
                                        </tr>
                                        </tbody>
                            </table>
<script>var checktHandsomepointUsableAmount = parseInt('450000.0');</script>
</div>
                        <!--//table wrap1-->
                                    ...
                                    <table class="tbl_wtype1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input value="" title="수령인" id="rcpt_name" name="lastName" maxlength="13" type="text" style="width: 118px;"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form_hyphen">-</div> <input title="휴대폰 번호 가운데자리" name="hp_num2" id="hp_num2" class="hp_num2" type="text" maxlength="4" numberonly="true">
                                                    <div class="form_hyphen">-</div> <input title="휴대폰 번호 뒷자리" name="hp_num3" id="hp_num3" class="hp_num2" type="text" maxlength="4" numberonly="true"> <!-- //hp -->
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form_hyphen">-</div> <input title="연락처 가운데자리" name="ph_num2" id="ph_num2" class="hp_num2" type="text" maxlength="4" numberonly="true">
                                                    <div class="form_hyphen">-</div> <input title="연락처 뒷자리" name="ph_num3" id="ph_num3" class="hp_num2" type="text" maxlength="4" numberonly="true"> <!-- //phone -->
                                                </td>
                                            </tr>
                                            <tr>
														...
														<div class="input_sumtxt_box input_sumtxt_box2">
															...
															<div class="delivery_comt delivery_comt2" style="display: none;">
																<ul>
																	...
																	<li style="background: rgb(248, 248, 248);"><a href="#;" data-default="공동현관 출입번호" data-input-display="block">공동현관 출입번호</a></li>
																	<li><a href="#;" data-default="자유 출입 가능" data-input-display="none">자유 출입 가능</a></li>
																	<li style="background: rgb(248, 248, 248);"><a href="#;" data-default="기타" data-input-display="block">기타</a></li>
																</ul>
															</div>
														</div>
													</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- email --> <input type="text" id="mail" name="mail" title="이메일 아이디" class="em_form"> <span class="andmail">@</span>
                                                    <input type="text" value="" name="emailDely" id="emailDely" title="직접입력" class="em_form"> <select title="이메일 계정" id="emailDelySel" class="em_select">
	                                                 ...
	                                                 <div class="coupon_select_wrap" style="margin-top:15px">
	                                                     ...
	                                                     <select title="쿠폰을 선택해 주세요." id="selectVoucher" style="width: 190px;">
					                                        <option value="">쿠폰을 선택해 주세요.</option>
					                                            <option value="FW2-022-100-6HK-E8M-F4D">[1만원] FRIEND 등급 축하 바우처
					                                                            / ₩
					                                                            10,000</option>
					                                                    <option value="FX2-022-100-6HJ-AG6-24F">[10%] FRIEND 등급 축하 바우처
					                                                            /
					                                                            10%
					                                                        </option>
					                                                    </select>
                                           ...
                                           <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="oclk_card_list_wrap" id="oclk_card_list_wrap">
													    <div class="card_easy_pay_wrap swiper-container swiper_card_easy_pay swiper-container-horizontal swiper-container-wp8-horizontal" id="card_easy_pay">    <ul class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">        <li class="swiper-slide swiper-slide-active" style="margin-right: 25px;">            <div class="card_item cd_kind_add">                <a href="#none" class="card_add_btn" id="btnCardRegist">카드등록</a>            </div>        </li>    </ul></div>
													    <a href="#;" class="prev_oclk_slide_btn oclks_btn1905 swiper-button-disabled" style="display: none;">이전</a>
													    <a href="#;" class="next_oclk_slide_btn oclks_btn1905 swiper-button-disabled" style="display: none;">다음</a>
													</div>
                                                ...
                                                <div class="ckout_wrap" id="ckout_wrap" style="display: none;">
                                                    <p>※ 한섬마일리지/기프트카드와 가상계좌 함께 사용 시, 입금시점에 한섬마일리지/기프트카드의 결제 잔액이
                                                        있어야 주문이 완료됩니다.</p>
                                                    <p id="virtualText" style="display: none;">※ <font color="red">4시간 이내 입금</font> 하셔야 주문이 완료 됩니다.</p>
...
(5만원이상 결제시/1,2,3,4회차 고객부담, 잔여할부 수수료 면제/법인,체크,기프트카드 제외)</td>
                                                    ...
                                                    <tr>
                                                            <th scope="row"><span class="card"><img src="/medias/SAMSUNG.jpg?context=bWFzdGVyfHJvb3R8MzIxOXxpbWFnZS9qcGVnfGgzZC9oNGQvODgxNDE4MTYxMzU5OC5qcGd8ZGY1NDJiM2U1YWNmNGE5MTJkOTA0MTAxMDliMDc4ZjRlNTJmZjJlOTkxOTQzZTEwMDcxZWU2NGU2MjJmMWE2Mw" alt="삼성카드"></span></th>
                                                            <td><b>10개월 부분무이자</b><br>
(5만원이상 결제시/1,2,3,4회차 고객 부담, 잔여할부 수수료 면제/법인,체크,기프트카드 제외)</td>
                                                            <td>행사기간 : 2022.10.01
                                                                ~ 2022.10.31</td>
                                                        </tr>
                                                    <tr>
...
(5만원이상 결제시/1,2,3,4,5회차 고객부담, 잔여할부 수수료 면제/법인,체크,기프트카드 제외)</td>
    ...
    <dl class="clearfix">
        ...
        <dd class="sub_total190816" id="sub_sumprice">₩${order_sumprice }
        <input type="hidden" id="subsumprice" value="${order_sumprice}"/>
        </dd>
...
<div class="total">
    <dl class="clearfix">
        <dt>
			합계</dt>
		<dd id="totalPrice">₩${order_sumprice }</dd>
    </dl>
</div>
...
<input type="hidden" name="voucherRateCheck" id="voucherRateCheck" value="">
                        ...
                        <div class="p_a_box">
                                <div class="point">
                                    <!-- 간편회원이 아닐 때 s -->
                                        ...
                                        <!-- 간편회원이 아닐 때  e -->
                                        <input type="hidden" name="accumulationPoint" id="accumulationPoint" value="22500">
                                    <input type="hidden" name="accumulationHPoint" id="accumulationHPoint" value="450">    
                                </div>
                                
                                <div class="agree">
                                    <input type="checkbox" id="agree"><label for="agree" class="tlt">[필수] 구매자 동의 </label>
                                    <p class="txt">
...
<input type="hidden" name="CSRFToken" value="77b0e71f-1c68-403d-8ba3-1c8b76071cce">
        ...
        <div class="popwrap w_type_4" id="popwrap2" style="display: none;">
            ...
            <div class="pop_cnt ">
                <div class="tblwrap">
                    <form id="userInfoForm" action="/ko/checkout/ordersheet" method="post"><input id="uid" name="uid" type="hidden" value="gary3545">
...
<input type="hidden" name="CSRFToken" value="77b0e71f-1c68-403d-8ba3-1c8b76071cce">
                ...
                <div class="btnwrap">
                    <input type="button" class="btn wt_s" value="취소" onclick="$('.btn_close').click();"> <input type="button" class="btn gray_s mr0" value="확인" onclick="checkPassword();">
                </div>
            </div>
            <!-- btn_close -->
