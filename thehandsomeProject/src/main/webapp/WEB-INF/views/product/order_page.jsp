...
<div id="bodyWrap">
	...
	<form id="orderForm" action="/ko/checkout/ordersheet" method="post">
		...
		<input type="hidden" id="globalPayment" name="globalPayment" value=""><input
			...
			id="ordererEmail" value=""> <input type="hidden"
			name="addressId" id="addressId" value=""> <input
			type="hidden" name="email" id="email" value=""> <input
			type="hidden" id="discInfo_coupon" name="couponCode" value="">
		<input type="hidden" id="customDutiesPaymentYN"
			name="customDutiesPaymentYN" value="0"> <input type="hidden"
			id="chinaYN" name="chinaYN"> <input type="hidden"
			id="idCardOrPassport" name="idCardOrPassport"> <input
			type="hidden" id="selectedCompany" name="selectedCompany" value="">
		<input type="hidden" id="isPermanentCompany" name="isPermanentCompany"
			value=""> <input type="hidden" name="wpayToken" value="">
		<input type="hidden" name="cardQuota" value=""> <input
			type="hidden" name="cardInterest" value=""> <input
			...
			<div class="orderwrap del_pay">
				...
				<div class="float_left">
								...
								<tr class="al_middle">
									<td class="frt">
										...
										<div class="pt_list_all">
											<a
												...
												<img src=${colorVO.cimage1 } alt="">
											</a>
											<div class="tlt_wrap">
												<a
													href="/ko/HANDSOME/MEN/TOP/SHIRTS/%ED%94%8C%EB%9E%A9-%ED%8F%AC%EC%BC%93-%EC%85%94%EC%B8%A0/p/SH2CAWSH714M_NY_100"
													class="basket_tlt"> <span class="tlt">${productVO.bname}</span>
									...
									<td>
										...
										<div class="price_wrap ">
											<span id="sum_price"> ₩ ${order_sumprice}</span><input
							...
							<tbody>
								<tr>
									...
									<td>
										...
										name="postcode" class="post" type="text" readonly="">
												...
												<div class="delivery_comt" style="display: none;">
													<ul>
														<li><a href="#;" data-readonly="readonly"
															deliveryrequestmessage="배송 전 연락 바랍니다"> 배송 전 연락 바랍니다</a></li>
														<li style="background: rgb(248, 248, 248);"><a
															href="#;" data-readonly="readonly"
														...
														<li style="background: rgb(248, 248, 248);"><a
															href="#;" data-readonly="readonly"
															deliveryrequestmessage="빠른 배송 부탁드립니다"> 빠른 배송 부탁드립니다</a></li>
														<li><a href="#;" data-readonly="readonly"
															deliveryrequestmessage="부재 시 핸드폰으로 연락바랍니다"> 부재 시
																핸드폰으로 연락바랍니다</a></li>
														<li style="background: rgb(248, 248, 248);"><a
															href="#;" data-readonly="write"
									...
									<td>
										...
										<div class="ckout_wrap" id="ckout_wrap" style="display: none;">
											<p>※ 한섬마일리지/기프트카드와 가상계좌 함께 사용 시, 입금시점에 한섬마일리지/기프트카드의 결제
												잔액이 있어야 주문이 완료됩니다.</p>
											<p id="virtualText" style="display: none;">
					...
					<div class="pack_opt_wrap wd">
						...
						<div>
							<input type="checkbox" name="pack_option" id="packopt"> <label
								for="pack_option" onclick="$('#packopt').click();"
					...
					<div class="ce_tab_container mt40">
								...
								<tbody>
									<tr>
										<th scope="row"><span class="card"><img
												...
												alt="신한카드"></span></th>
										<td><b>신한카드 5만원이상 결제시 2~6개월 무이자 할부</b><br> 대상: 신한카드
											전 회원<br> (신한BC 제외/ 법인,기프트,체크,선불카드 제외)</td>
									...
									<tr>
										<th scope="row"><span class="card"><img
												...
												alt="삼성카드"></span></th>
										<td><b>삼성카드 5만원이상 결제시 2~6개월 무이자 할부</b><br> 대상: 삼성카드
											전 회원<br> (법인,기프트,체크,선불카드 제외)</td>
										<td>행사기간 : 2022.10.01 ~ 2022.10.31</td>
									</tr>
									<tr>
										<th scope="row"><span class="card"><img
												...
												alt="비씨카드"></span></th>
										<td><b>비씨카드 5만원이상 결제시 2~7개월 무이자 할부</b><br> 대상: 비씨카드
											전 회원<br>(법인,기프트,체크,선불카드 제외)</td>
										<td>행사기간 : 2022.10.01 ~ 2022.10.31</td>
									</tr>
									<tr>
										<th scope="row"><span class="card"><img
												...
												alt="현대카드"></span></th>
										<td><b>현대카드 5만원이상 결제시 2~7개월 무이자 할부</b><br> 대상: 현대카드
											전 회원<br> (법인,기프트,체크,선불카드 제외)</td>
										<td>행사기간 : 2022.10.01 ~ 2022.10.31</td>
									</tr>
									<tr>
									...
									<tr>
										<th scope="row"><span class="card"><img
												...
												alt="하나카드"></span></th>
										<td><b>하나카드 5만원이상 결제시 2~8개월 무이자 할부</b><br> 대상: 하나카드
											전 회원 (구 하나SK, 구 외환)<br> (하나BC카드 포함/법인,기프트,체크,선불카드 제외)</td>
										<td>행사기간 : 2022.10.01 ~ 2022.10.31</td>
									</tr>
									<tr>
										<th scope="row"><span class="card"><img
								...
								<tbody>
									...
									<tr>
										<th scope="row"><span class="card"><img
												src="/medias/SAMSUNG.jpg?context=bWFzdGVyfHJvb3R8MzIxOXxpbWFnZS9qcGVnfGgzZC9oNGQvODgxNDE4MTYxMzU5OC5qcGd8ZGY1NDJiM2U1YWNmNGE5MTJkOTA0MTAxMDliMDc4ZjRlNTJmZjJlOTkxOTQzZTEwMDcxZWU2NGU2MjJmMWE2Mw"
												alt="삼성카드"></span></th>
										<td><b>10개월 부분무이자</b><br> (5만원이상 결제시/1,2,3,4회차 고객
											부담, 잔여할부 수수료 면제/법인,체크,기프트카드 제외)</td>
										<td>행사기간 : 2022.10.01 ~ 2022.10.31</td>
									</tr>
									<tr>
										<th scope="row"><span class="card"><img
						...
						<div style="display: none;">
							...
							<!--//Table wrap-->
							<div id="nowSale1Img" style="display: none;">
						...
						<div>
							...
							<dl class="clearfix">
								...
								<dd class="sub_total190816" id="sub_sumprice">
									₩${order_sumprice } <input type="hidden" id="subsumprice"
										value="${order_sumprice}" />
								</dd>
...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				const milege_price = '${order_hsm}'.replace(
						/\B(?=(\d{3})+(?!\d))/g, ',');
				const Hpoint_price = '${order_hspoint}'.replace(
						/\B(?=(\d{3})+(?!\d))/g, ',');
